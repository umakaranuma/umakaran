        ...
        <div className={styles.heroContent}>
          ...
          <div className={styles.heroSocialsRow}>
            ...
            <a href="https://wa.me/94769214278" target="_blank" rel="noopener" className={`${styles.si} ${styles.siWa}`} aria-label="WhatsApp">
               <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 1 1-7.6-11.7c.9 0 1.8.2 2.6.5l3.9-1.2-1.2 3.9c.3.8.5 1.7.5 2.6z"/><path d="M10 10.3c.2-.4.5-.8.9-1a.5.5 0 0 1 .6 0l1.2 1.2a.5.5 0 0 1 0 .6l-.3.3a.5.5 0 0 0 0 .6l1.2 1.2a.5.5 0 0 0 .6 0l.3-.3a.5.5 0 0 1 .6 0l1.2 1.2a.5.5 0 0 1 0 .6c-.3.4-.6.7-1 1a3 3 0 0 1-4 0c-.4-.3-.7-.6-1-1a3 3 0 0 1 0-4z"/></svg>
            </a>
